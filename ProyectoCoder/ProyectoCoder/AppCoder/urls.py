...
urlpatterns = [
    ...
    path('eliminarJugador/<numero_para_borrar>',
         views.eliminarJugador, name="EliminarJugador"),
    path('editarJugador/<numero_para_editar>',
         views.editarJugador, name="EditarJugador"),
]
